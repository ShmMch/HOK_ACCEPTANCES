...
import FinishedReportModel from '../models/finishedReport.model';
import FinishedReportRecordModel from '../models/finishedReportRecord.model'

export default class FinishedReportGenerator {

    constructor(organization, date) {
    ...
    getReportData() {
        ...
        return Promise.all([getCollectionPromise, getCustomersPromise, getProgramsPromise])
            ...
            .then(reportRecords => {
                ...
                return new FinishedReportModel({
                    organization: {
